...
public class ResourceController {
    ...
    public ResponseEntity<?> view(@PathVariable String id, Authentication authentication) {
        User currentUser = (User) authentication.getPrincipal();
    ...
    // @Operation(summary = "Increase resource views", description = "Increment view counter of a resource")
    // @PostMapping("/{id}/view")
    // @PreAuthorize("permitAll()")
    // public ResponseEntity<?> increaseView(@PathVariable String id, Authentication authentication) {
